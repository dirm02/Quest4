...
import { services } from 'src/app/shared/models/data-table-model';
...
export class ServicesComponent implements OnInit{
  ...
  private getTableData(): void {
    ...
    this.data.getServices().subscribe((data: apiResultFormat) => {
      this.totalData = data.totalData;
      data.data.map((res: services, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<services>(this.services);
