...
@Component({
    selector: 'app-provider-security-settings',
    templateUrl: './provider-security-settings.component.html',
    styleUrls: ['./provider-security-settings.component.css'],
    standalone: false
})
export class ProviderSecuritySettingsComponent {
